export default function AdminDashboardPage({ onNavigate }: { onNavigate: (step: 'student-management' | 'exam-management' | 'question-management' | 'exam-results') => void }) {
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-6 bg-blue-50 rounded-xl border border-blue-100">
          ...
          <button onClick={() => onNavigate('exam-management')} className="bg-blue-600 text-white px-4 py-2 rounded-lg">Kelola Ujian</button>
        </div>
        <div className="p-6 bg-green-50 rounded-xl border border-green-100">
          ...
          <button onClick={() => onNavigate('question-management')} className="bg-green-600 text-white px-4 py-2 rounded-lg">Kelola Soal</button>
        </div>
        ...
        <div className="p-6 bg-yellow-50 rounded-xl border border-yellow-100">
          ...
          <button onClick={() => onNavigate('exam-results')} className="bg-yellow-600 text-white px-4 py-2 rounded-lg">Lihat Hasil</button>
        </div>
      </div>
    </div>
  );
